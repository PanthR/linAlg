...
describe('Dense matrices', function() {
   ...
   it('return null for out-of-bounds indices', function() {
      expect(A1.get(0, 1)).to.equal(null);
      expect(A1.get(2, 0)).to.equal(null);
      expect(A1.get(3, 1)).to.equal(null);
      expect(A1.get(1, 4)).to.equal(null);
      expect(A1.get(4, 1)).to.equal(null);
   });
})
